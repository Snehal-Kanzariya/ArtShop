...
<body>
    ...
    <!--================login_part Area =================-->
    <section class="login_part login_section">
                        ...
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="login_process.php" method="post" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="submit" value="login"  name="login" class="btn_3">
                                       
                                    <p class="login-register-text">Don't have an account? <a href="Signup.php" target="_blank">Register Here</a></p>
